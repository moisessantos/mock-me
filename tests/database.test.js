const { getResult, mockResult, clearDatabase, getDatabase } = require('../database');
...
describe('getResult tests', () => {
    ...
    it('should return default value when guid is not in database', () => {
        expect(getResult(guid)).toEqual({ response: 'default mock content' });
    });
